...
module.exports = function(app, cb) {
  ...
  Object.keys(sampleInitiativeData).forEach(modelName => {
    ...
    modelItems.forEach(modelItem => {
      app.models.initiative.findOne({where: {'title': modelItem.title}},
        function(err, oldInitiative) {
          if (!oldInitiative) {
                  ...
                  app.models.user.findOne(
                    ...
                    function(err, initiativeCreatedUser) {
                      if (initiativeCreatedUser) {
                        ...
                        Promise.resolve(Model.upsertWithWhere(
                          {'title': modelItem.title}, modelItem))
